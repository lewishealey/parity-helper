    ...
    <>
      {getStarted ? (
        ...
        <div
          ...
          <div className="border-none bg-white dark:bg-gray-800 rounded-2xl p-8 h-full">
            <div className="flex flex-col items-scenter justify-center space-y-8">
              <div className="relative p-0 space-y-8 rounded-2xl flex flex-col justify-between items-center">
                ...
                <p className="text-2xl text-black dark:text-gray-300 text-center" style={{ lineHeight: "125%" }}>Lets bring design and code together. Evaluate the code parity of your Design System’s Figma components and get actionable improvement suggestions.</p>
                <button
                  type="submit"
                ...
                <div className="text-xl dark:text-gray-300">Brought to you by <a href="https://designsystemdiaries.com/?utm_source=parity_booster&utm_medium=quiz_start" className="underline">Design system Diaries</a></div>
              </div>
            </div>
          </div>
        </div>
